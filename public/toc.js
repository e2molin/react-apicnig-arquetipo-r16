  ...
  groups: [
    {
      ...
      services: [
        ...
        {
          name: 'Nomenclátor Geográfico Básico de España (IGN)',
          type: 'WMS',
    ...
    },
    {
      ...
      services: [
        ...
        {
          name: 'Edificios de la C.F. de Navarra',
          type: 'WMS',
          url: 'https://inspire.navarra.es/services/BU/wms',
          white_list: ['BU:Building'],
        },
        {
